...
| <a name="input_opensearch_pass"></a> [opensearch\_pass](#input\_opensearch\_pass) | The password can only contain alphanumeric characters or hyphens `-`.<br>Require at least 10 characters, one uppercase letter, one lowercase letter and one number.<br>Example: `qfeE42snU-bt0y-1xPWefQDq` DO NOT USE **THIS** EXAMPLE PASSWORD. | `string` | n/a | yes |
...
| Name | Type |
|------|------|
| [elestio_opensearch.nodes](https://registry.terraform.io/providers/elestio/elestio/0.13.0/docs/resources/opensearch) | resource |
